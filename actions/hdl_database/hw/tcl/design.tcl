...
set engine_config $::env(DATABASE_ENGINE_CONFIG)
set regex_engine "FALSE"
set gqejoin_engine "FALSE"

if { ($engine_config == "regex_8x1") || ($engine_config == "regex_16X1") || ($engine_config == "regex_64X1") } {
    set regex_engine "TRUE"
}

if { $engine_config == "vitis_gqeJoin" } {
    set gqejoin_engine "TRUE"
}

add_files -scan_for_includes -norecurse $action_hw/framework

if { $regex_engine == "TRUE" } {
...
foreach ip_xci [exec find $action_ip_dir/framework -name *.xci] {
